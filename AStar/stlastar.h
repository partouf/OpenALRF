...
public: // methods
   ...
   AStarSearch() :
      m_State(STLAStar::SEARCH_STATE_NOT_INITIALISED),
   ...
   void SetStartAndGoalStates(UserState &Start, UserState &Goal)
   {
      ...
      m_State = STLAStar::SEARCH_STATE_SEARCHING;
   ...
   unsigned int SearchStep()
   {
      ...
      assert((m_State > STLAStar::SEARCH_STATE_NOT_INITIALISED) &&
         (m_State < STLAStar::SEARCH_STATE_INVALID));

      // Next I want it to be safe to do a searchstep once the search has succeeded...
      if ((m_State == STLAStar::SEARCH_STATE_SUCCEEDED) ||
         (m_State == STLAStar::SEARCH_STATE_FAILED)
         )
      {
         return m_State;
      }
      ...
      if (n->m_UserState.IsGoal(m_Goal->m_UserState))
      {
         ...
         m_State = STLAStar::SEARCH_STATE_SUCCEEDED;
      ...
      else // not goal
      {
         ...
         if (!ret)
         {
            ...
            m_State = STLAStar::SEARCH_STATE_OUT_OF_MEMORY;
            return m_State;
         }
   ...
   {
      if (m_Goal && m_State == STLAStar::SEARCH_STATE_SUCCEEDED)
      {
         return m_Goal->g;
      }
      else
